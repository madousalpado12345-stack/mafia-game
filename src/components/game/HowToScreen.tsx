...
const PHASES = [
  ...
  },
  {
    emoji: "🏆",
    title: "الفوز",
    text: "يفوز المواطنون عند إخراج كل المافيا. تفوز المافيا عندما يصبح عددها مساويًا أو أكثر من المواطنين القادرين على التصويت. وإذا أُخرج المهرج بالتصويت فاز وحده بالمباراة! 🎭",
  },
];
